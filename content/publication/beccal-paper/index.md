...
summary: This paper details the software architecture for the BECCAL mission on the ISS, focusing on the design and execution of experiments with ultra-cold atoms using a model-driven development approach and domain-specific languages.
